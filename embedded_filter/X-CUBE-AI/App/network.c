...
#define AI_NETWORK_MODEL_SIGNATURE     "3a6fbc21f015cc554941894058892614"
...
#define AI_TOOLS_DATE_TIME   "Sun Jun  4 16:25:07 2023"
...
AI_ARRAY_OBJ_DECLARE(
  rnn_3_kernel_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  rnn_3_recurrent_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 144, AI_STATIC)
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_output0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 40, AI_STATIC)
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  rnn_3_output0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 6, AI_STATIC)
/* Array#5 */
AI_ARRAY_OBJ_DECLARE(
  rnn_3_peephole_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  rnn_3_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 24, AI_STATIC)
/* Array#8 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_kernel_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_recurrent_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#12 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_peephole_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 24, AI_STATIC)
/* Array#13 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 56, AI_STATIC)
/* Array#14 */
AI_ARRAY_OBJ_DECLARE(
  rnn_2_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 32, AI_STATIC)
/* Array#15 */
AI_ARRAY_OBJ_DECLARE(
  rnn_3_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 42, AI_STATIC)
/**  Tensor declarations section  *********************************************/
/* Tensor #0 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_kernel, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 8, 1, 1, 24), AI_STRIDE_INIT(4, 4, 4, 96, 96),
  1, &rnn_3_kernel_array, NULL)
...
/* Tensor #2 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_recurrent, AI_STATIC,
  2, 0x0,
  AI_SHAPE_INIT(4, 6, 1, 1, 24), AI_STRIDE_INIT(4, 4, 4, 96, 96),
  1, &rnn_3_recurrent_array, NULL)

/* Tensor #3 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_output0, AI_STATIC,
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 5), AI_STRIDE_INIT(4, 4, 4, 32, 32),
  1, &rnn_2_output0_array, NULL)

/* Tensor #4 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_output0, AI_STATIC,
  4, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 1, 1), AI_STRIDE_INIT(4, 4, 4, 24, 24),
  1, &rnn_3_output0_array, NULL)

/* Tensor #5 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_peephole, AI_STATIC,
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 18, 1, 1), AI_STRIDE_INIT(4, 4, 4, 72, 72),
  1, &rnn_3_peephole_array, NULL)
...
/* Tensor #7 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_bias, AI_STATIC,
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 24, 1, 1), AI_STRIDE_INIT(4, 4, 4, 96, 96),
  1, &rnn_3_bias_array, NULL)

/* Tensor #8 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_kernel, AI_STATIC,
  8, 0x0,
  AI_SHAPE_INIT(4, 3, 1, 1, 32), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &rnn_2_kernel_array, NULL)

/* Tensor #9 */
AI_TENSOR_OBJ_DECLARE(
  dense_4_dense_weights, AI_STATIC,
  9, 0x0,
  AI_SHAPE_INIT(4, 6, 2, 1, 1), AI_STRIDE_INIT(4, 4, 24, 48, 48),
  1, &dense_4_dense_weights_array, NULL)

/* Tensor #10 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_recurrent, AI_STATIC,
  10, 0x0,
  AI_SHAPE_INIT(4, 8, 1, 1, 32), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &rnn_2_recurrent_array, NULL)
...
/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_peephole, AI_STATIC,
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 24, 1, 1), AI_STRIDE_INIT(4, 4, 4, 96, 96),
  1, &rnn_2_peephole_array, NULL)

/* Tensor #13 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_scratch0, AI_STATIC,
  13, 0x0,
  AI_SHAPE_INIT(4, 1, 56, 1, 1), AI_STRIDE_INIT(4, 4, 4, 224, 224),
  1, &rnn_2_scratch0_array, NULL)

/* Tensor #14 */
AI_TENSOR_OBJ_DECLARE(
  rnn_2_bias, AI_STATIC,
  14, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &rnn_2_bias_array, NULL)

/* Tensor #15 */
AI_TENSOR_OBJ_DECLARE(
  rnn_3_scratch0, AI_STATIC,
  15, 0x0,
  AI_SHAPE_INIT(4, 1, 42, 1, 1), AI_STRIDE_INIT(4, 4, 4, 168, 168),
  1, &rnn_3_scratch0_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_3_output0),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  rnn_3_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_2_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_3_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 9, &rnn_3_kernel, &rnn_3_recurrent, &rnn_3_peephole, &rnn_3_bias, NULL, NULL, NULL, NULL, NULL),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_3_scratch0)
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  rnn_2_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &input_0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_2_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 9, &rnn_2_kernel, &rnn_2_recurrent, &rnn_2_peephole, &rnn_2_bias, NULL, NULL, NULL, NULL, NULL),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &rnn_2_scratch0)
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    3200, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 444, 1, 1),
    444, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_4_dense_output),
  &rnn_2_layer, 0, NULL)
